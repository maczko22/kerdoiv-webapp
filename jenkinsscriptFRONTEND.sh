...
destAbsPath=~/builds/$projectName/$env/
configFolder=resources/static
##############################################################
...
sourFile=$WORKSPACE/build/libs/$projectName/public/.
